...
export default function PromotionUpload() {
  ...
  const fakeCategories = [
    ...
    { id: 2, name: 'Laptop & Máy tính bảng' },
    { id: 3, name: 'Tai nghe & Loa' },
    { id: 4, name: 'Đồng hồ thông minh' },
    { id: 5, name: 'Máy ảnh & Camera' },
    { id: 6, name: 'TV & Màn hình' },
    { id: 7, name: 'Đồ gia dụng' },
    { id: 8, name: 'Thời trang nam' },
    { id: 9, name: 'Thời trang nữ' },
    { id: 10, name: 'Giày dép' },
  ];
  ...
  const searchCategories = async (keyword) => {
    ...
    try {
      ...
      console.log('search category res: ', res.data);
